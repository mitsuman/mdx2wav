...
static MXDRVG_WORK_CH volatile *A6;
...
void volatile *MXDRVG_GetWork(
	...
	switch (i) {
	  case MXDRVG_WORKADR_FM:
		return (void *)&MXDRVG_WORK_CHBUF_FM[0];
	  case MXDRVG_WORKADR_PCM:
		return (void *)&MXDRVG_WORK_CHBUF_PCM[0];
	  case MXDRVG_WORKADR_GLOBAL:
		return (void *)&G;
	  ...
	  case MXDRVG_WORKADR_CREDIT:
		return (void *)&MXDRVG_WORK_CREDIT;
	  case MXDRVG_WORKADR_OPMINT:
...
*/
	G.L002245 = CLR;
	D1=d1, D2=d2, D3=d3, D4=d4, D5=d5, D6=d6, D7=d7, A0=a0, A1=a1, A2=a2, A3=a3, A4=a4, A5=a5, A6=(MXDRVG_WORK_CH *)a6;
...
*/
	...
	D7 = D0;
	if ( D0 < 0x09 ) {
		A6 = &MXDRVG_WORK_CHBUF_FM[D0];
	} else {
		A6 = &MXDRVG_WORK_CHBUF_PCM[D0-9];
	}
